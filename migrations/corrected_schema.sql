-- Purpose: Master schema combining all tables for the vehicle rental system.
-- Website Section: Full Platform (auth, catalog, booking/payment, tracking, admin).
-- Developer Notes: Use for fresh installs or reference for migrations; keep aligned with UI flow and gateway fields.
